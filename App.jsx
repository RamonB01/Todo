  ...
  return (
    <>
      ...
      <form >
        ...
        <input type="text" name="nombre" value={nombre} onChange={(e) => setNombre(e.target.value)} /> <br />

        <label htmlFor="edad">Edad   </label>
        <input type="numbre" name="edad" value={edad} onChange={(e) => setEdad(Number(e.target.value))} /> <br />
